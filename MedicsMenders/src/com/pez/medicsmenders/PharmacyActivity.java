...
public class PharmacyActivity extends FragmentActivity {
	...
	.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
		...
		public void onInfoWindowClick(Marker marker) {
			Intent nextScreen = new Intent(PharmacyActivity.this,
	...
	if (!isInternetPresent) {
		alert.showAlertDialog(PharmacyActivity.this, "Internet Connection Error",
	...
	if (gps.canGetLocation()) {
		...
		alert.showAlertDialog(PharmacyActivity.this, "GPS Status",
	...
	btnPharmacy.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View arg0) {
			Intent i = new Intent(PharmacyActivity.this,
					DisplayPlacesListActivity.class);
			i.putExtra("near_places", nearPlaces);
			i.putExtra("target", "pharmacy");
			startActivity(i);
		}
	});
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
    	...
    	protected void onPreExecute() {
    		super.onPreExecute();
    		pDialog = new ProgressDialog(PharmacyActivity.this);
	...
	alert.showAlertDialog(PharmacyActivity.this, "Near Places",
	"Sorry no places found. Try to change the types of places",
	false);
	}
	else if(status.equals("UNKNOWN_ERROR"))
	{
		alert.showAlertDialog(PharmacyActivity.this, "Places Error",
